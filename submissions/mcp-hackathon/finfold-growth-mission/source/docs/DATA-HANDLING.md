...
| Tracking clicks | Daily aggregate | 30 days with mission | No IP address, user agent, cookie, or fingerprint is stored. |
| Outcome events | Yes | 30 days with mission | Caller event ID, type, quantity/value, currency, and time; no required PII fields. |
